...
● UserPromptSubmit operation blocked by hook:                                                  
  [python3 ${CLAUDE_PLUGIN_ROOT}/hooks/bedrock_limiter.py]: ⛔ 日次コスト上限超過:             
  $3.9745 / $3.00                                                                              
     config.json の daily_limit_usd を変更するか、明日以降に再開してください。                 
...
- Python 3.x がインストールされていること (`python3 --version` で確認)
